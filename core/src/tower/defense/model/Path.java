...
public class Path {
   ...
   private final int[][] path2 = {{9,1,9,9,9,9,9,9},{9,1,9,9,4,5,6,9},{9,1,9,9,4,9,6,9},{9,1,9,9,4,9,6,9},{9,1,2,3,4,9,6,9},{9,9,9,9,9,9,6,9},{9,9,9,9,9,9,6,9},{9,1,2,3,4,5,6,9},{9,1,9,9,9,9,9,9},{9,1,9,9,9,9,9,9}};
    public Path(){
        for(int i=0; i<10; i++){
            for(int j=0; j<8; j++){
               if(j!=path2[i][j]){
